...
func SaveOrderbooks(db *DB, pair exchanger.Pair, start time.Time, obs []*exchanger.OrderBook) {
	placeholders := []string{}
	params := []interface{}{}
...
func ComputeAndSaveArbitrage(db *DB, pair exchanger.Pair, start time.Time, obs []*exchanger.OrderBook) {
	placeholders := []string{}
	params := []interface{}{}
